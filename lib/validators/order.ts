...
const orderItemSchema = z.object({
  ...
  paperType: z.string().max(50).optional().or(z.literal("")),
  backing: z.string().max(50).optional().or(z.literal("")),
  adhesive: z.string().max(50).optional().or(z.literal("")),
  thickness: z.string().max(20).optional().or(z.literal("")),
