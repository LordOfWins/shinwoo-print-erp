...
const s = StyleSheet.create({
  page: { fontFamily: FONT_FAMILY, fontSize: 7.5, color: COLORS.black, padding: 0 },
  ...
  dashScissor: { fontSize: 8, color: "#AAAAAA", marginHorizontal: 4 },
  ...
  transDate: { fontSize: 8, color: COLORS.darkGray },
  headerRight: { flexDirection: "row", alignItems: "center", gap: 6 },
  transNo: { fontSize: 7.5, color: COLORS.gray },
  copyLabel: { fontSize: 7.5, color: COLORS.gray, border: "0.5pt solid #999999", paddingHorizontal: 4, paddingVertical: 1 },
  infoRow: { flexDirection: "row", gap: 5, marginBottom: 4 },
  infoBox: { flex: 1, border: "0.5pt solid #000000" },
  infoBoxTitle: { fontSize: 7.5, fontWeight: "bold", textAlign: "center", padding: 1.5, backgroundColor: "#E8E8E8", borderBottom: "0.5pt solid #000000" },
  ...
  infoLabel: { width: 46, fontSize: 6.5, padding: 1.5, backgroundColor: "#F5F5F5", borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  infoValue: { flex: 1, fontSize: 6.5, padding: 1.5, justifyContent: "center" },
  ...
  thDate: { width: 42, fontSize: 6.5, fontWeight: "bold", textAlign: "center", padding: 1.5, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  thName: { width: 110, fontSize: 6.5, fontWeight: "bold", textAlign: "center", padding: 1.5, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  thSpec: { width: 54, fontSize: 6.5, fontWeight: "bold", textAlign: "center", padding: 1.5, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  thQty: { width: 34, fontSize: 6.5, fontWeight: "bold", textAlign: "center", padding: 1.5, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  thUnit: { width: 24, fontSize: 6.5, fontWeight: "bold", textAlign: "center", padding: 1.5, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  thUnitPrice: { width: 52, fontSize: 6.5, fontWeight: "bold", textAlign: "center", padding: 1.5, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  thSupply: { width: 60, fontSize: 6.5, fontWeight: "bold", textAlign: "center", padding: 1.5, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  thVatLast: { width: 50, fontSize: 6.5, fontWeight: "bold", textAlign: "center", padding: 1.5, justifyContent: "center" },
  tdDate: { width: 42, fontSize: 6.5, padding: 1.5, textAlign: "center", borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdName: { width: 110, fontSize: 6.5, padding: 1.5, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdSpec: { width: 54, fontSize: 6.5, padding: 1.5, textAlign: "center", borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdQty: { width: 34, fontSize: 6.5, padding: 1.5, textAlign: "right", borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdUnit: { width: 24, fontSize: 6.5, padding: 1.5, textAlign: "center", borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdUnitPrice: { width: 52, fontSize: 6.5, padding: 1.5, textAlign: "right", borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdSupply: { width: 60, fontSize: 6.5, padding: 1.5, textAlign: "right", borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdVatLast: { width: 50, fontSize: 6.5, padding: 1.5, textAlign: "right", justifyContent: "center" },
  tdDateEmpty: { width: 42, fontSize: 6.5, padding: 1.5, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdNameEmpty: { width: 110, fontSize: 6.5, padding: 1.5, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdSpecEmpty: { width: 54, fontSize: 6.5, padding: 1.5, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdQtyEmpty: { width: 34, fontSize: 6.5, padding: 1.5, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdUnitEmpty: { width: 24, fontSize: 6.5, padding: 1.5, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdUnitPriceEmpty: { width: 52, fontSize: 6.5, padding: 1.5, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdSupplyEmpty: { width: 60, fontSize: 6.5, padding: 1.5, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdVatLastEmpty: { width: 50, fontSize: 6.5, padding: 1.5, justifyContent: "center" },
  totalLabel: { width: 206, fontSize: 7.5, fontWeight: "bold", textAlign: "center", padding: 1.5, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  footerRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-end" },
  footerLeft: { flex: 1 },
  amountText: { fontSize: 8, fontWeight: "bold", marginBottom: 1 },
  bankText: { fontSize: 7, marginBottom: 1 },
  noteText: { fontSize: 6.5, color: COLORS.gray },
