      ...
      <Card>
        <CardContent className="space-y-6 pt-6">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            {/* 연락처 */}
            <div className="space-y-2">
              <Label htmlFor="phone" className="text-[0.95rem]">
                연락처
              </Label>
              <Input
                id="phone"
            ...
            {/* 팩스 */}
            <div className="space-y-2">
              <Label htmlFor="fax" className="text-[0.95rem]">
                팩스
              </Label>
              <Input
                id="fax"
              ...
              />
              {errors.fax && (
                <p className="text-destructive text-sm">{errors.fax.message}</p>
              )}
            </div>
            ...
            {/* 사업자번호 */}
            <div className="space-y-2">
              <Label htmlFor="businessNumber" className="text-[0.95rem]">
                사업자번호
              </Label>
              <Input
                id="businessNumber"
            ...
            {/* 업태 */}
            <div className="space-y-2">
              <Label htmlFor="businessType" className="text-[0.95rem]">
                업태
              </Label>
              <Input
                id="businessType"
            ...
            {/* 종목 */}
            <div className="space-y-2">
              <Label htmlFor="businessItem" className="text-[0.95rem]">
                종목
              </Label>
              <Input
                id="businessItem"
